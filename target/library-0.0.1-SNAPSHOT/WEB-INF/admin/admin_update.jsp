        ...
        <div class="panel-body">
            <form role="form" id="form1">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="adminname" name="adminname" value="${requestScope.admin.adminname}" placeholder="请输入名字">
                </div>
                <div class="form-group">
                    <label for="admintel">电话</label>
                    <input type="text" class="form-control" id="admintel" name="admintel" value="${requestScope.admin.admintel}" placeholder="请输入电话">
                </div>
                <div class="form-group">
                    <label for="adminaddress">地址</label>
                    <input type="text" class="form-control" id="adminaddress" name="adminaddress" value="${requestScope.admin.adminaddress}" placeholder="请输入地址">
                </div>
...
<script type="text/javascript">
    $(function () {
        $("#updateBtn").click(function(){
            ...
            $.ajax({
                type : "POST",
                url : "${pageContext.request.contextPath}/adminupdate",
                data : data,
                beforeSend : function(){
