    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form role="form" id="form1">
                <input type="hidden" name="booktypeid" value="${requestScope.booktype.booktypeid}"/>
                <div class="form-group">
                    <label for="booktypename">书籍类型</label>
                    <input type="text" class="form-control" id="booktypename" name="booktypename" placeholder="请输入书籍类型" value="${booktype.booktypename}">
                </div>
...
<script type="text/javascript">
    $(function () {
        $("#updateBtn").click(function(){
            ...
            $.ajax({
                type : "POST",
                url : "${pageContext.request.contextPath}/booktypeupdate",
                data : data,
                beforeSend : function(){
